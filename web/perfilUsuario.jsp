...
<html>
    ...
    <div class="row"> 
        <div class="span11">
            <html:form action="/Modificarusuario">
            <fieldset>
            <legend><bean:message key="perfil.titulo"/></legend>
            ...
            <div class="clearfix"></div>            
            <div class="span11" align="center"><html:submit styleClass="btn btn-danger  btn-primary"><bean:message key="perfil.actualiza"/></html:submit></div>
            <html:errors/>
            </fieldset>       
            </html:form>
        </div>
        <div><a href="principal.jsp" class="btn btn-success"><em class="icon-home icon-white"></em> <bean:message key="general.volvermenu"></bean:message></a></div>
    </div><!-- row -->
    </logic:equal>
    </logic:present>
