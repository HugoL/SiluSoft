 ...
 * @author ko
 */
public class ActualizarTratamientoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            if(TratamientosBO.esActualizado(tratamiento)!=null){
                return mapping.findForward(SUCCESS);           
           }else{
               System.out.println("Tratamiento no insertado");
